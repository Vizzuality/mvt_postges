...
This image uses the development versions of PostgreSQL and PostGIS. thanks to [GEOGRAPHICA](https://github.com/GeographicaGS/Docker-PostGIS/tree/master/Dev_Diplodocus_raster)
